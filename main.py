    """
    Ai Diff Tool Pze8coz
    ====================
    Developer-friendly AI library that helps you label documents programmatically.
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly AI library that helps you label documents programmatically.")
